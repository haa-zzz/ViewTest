...
public class MyViewPager_Scroller extends ViewGroup {
    private int mLastX;
    ...
    public MyViewPager_Scroller(Context context) {
        super(context);
        init(context);
    }

    public MyViewPager_Scroller(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public MyViewPager_Scroller(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()){
            ...
            case MotionEvent.ACTION_UP:
                ...
                int initVelocity = (int) velocityTracker.getXVelocity();        //水平方向的速度
